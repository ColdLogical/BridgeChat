...
public extension ChatView {
    ...
    func chatNavigation(title: String, status: String? = nil, cover: URL? = nil, callHandler: (() -> Void)? = nil, backHandler: (() -> Void)? = nil) -> some View {
        var view = self
    ...
    func chatTitleBar(title: String, status: String? = nil, cover: URL? = nil, avatarData: Data?, callHandler: (() -> Void)? = nil, backHandler: (() -> Void)? = nil, profileHandler: (() -> Void)? = nil) -> some View {
